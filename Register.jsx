...
function Register() {
  return (
    ...
    <div class='container-fluid'>
        ...
        <div class='col-sm-12 col-lg-6 ' style={{backgroundColor:'#BCF4F5'}}>
            <center>
        <form >
            <h2>Register</h2>
            <div class=' fw-bold' >
            ...
            <div class='p-2 fw-bold'>
                ...
                <input  class=' p-2' type="text" name="specialization" id="spec" placeholder='Specialization' style={{borderRadius:'10px',width:'90%'}} required />
            </div>
              <br />
         <div >
       
       <select  class=' p-2' id="city" name="city"  style={{borderRadius:'10px' ,width:'90%'}} required>
